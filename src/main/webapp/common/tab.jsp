...
<nav id="tab" class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="collapse navbar-collapse">
    <ul class="nav nav-pills">
      <li class="nav-item">
        <a class="nav-link" href="#total-view" data-tab="total-view">종합</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link btn dropdown-toggle" href="#player-view" data-bs-toggle="dropdown" aria-expanded="false" data-tab="player-view">선수 항목</a>
